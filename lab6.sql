...
/*checking task2 and task3*/

--26
ALTER TABLE Rating ADD CONSTRAINT ratingFK1 FOREIGN KEY(rID) references Reviewer 
	ON UPDATE CASCADE ON DELETE SET NULL;

--27
ALTER TABLE Rating ADD CONSTRAINT ratingFK2 FOREIGN KEY(mID) references Movie ON DELETE CASCADE;

/*checking task4*/

--Final check (35)
SELECT sum(rID) FROM Rating WHERE rID IS NOT NULL; --output 853

SELECT count(*) FROM Rating WHERE rID IS NULL; --output 3